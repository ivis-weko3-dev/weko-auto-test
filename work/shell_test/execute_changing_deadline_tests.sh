...
declare -A jp=(
    ...
    ['before_exec_msg2']='有効期限の変更後、3日を過ぎていても問題ないことを確認するため、マシンの時間を4日ずらす必要があります。'
...
declare -A en=(
    ...
    ['before_exec_msg2']='After changing the expiration date, you need to shift the time in the machine by 4 days to confirm that it is not a problem even after 3 days have passed.'
